...
if (document.cookie.indexOf('flakes=') === -1) {
...
const numberOfSnowflakes = flakes;
...
function Snowflake(element, speed, xPos, yPos) {
    ...
    this.element.style.opacity = "" + (0.22 + Math.random()) / 3;
}
...
// const netdataServer = "https://netdata.the-archive.xyz/";